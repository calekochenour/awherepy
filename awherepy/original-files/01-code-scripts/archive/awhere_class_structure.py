...
# Abstract class - root of hierarchy
...
# Subclasses to delineate field-based and location-based data


class Geolocation(AWhereAPI):
    # Constructor - can be invoked by derived classes
    def __init__(self, api_key, api_secret, base_64_encoded_secret_key, auth_token, latitude, longitude):
