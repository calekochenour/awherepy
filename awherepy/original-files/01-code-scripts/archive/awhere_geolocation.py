...
class AWhereAPI():
    ...
    def get_weather_norms(self, latitude, longitude, start_day, end_day=None, offset=0):
        """
        ...
        # Perform the HTTP request to obtain the norms for the Field
        # Define URL variants
        url_single_day = f"{self._geolocation_url}/{latitude},{longitude}/norms/{start_day}?limit=10&offset={offset}"
        url_multiple_days = f"{self._geolocation_url}/{latitude},{longitude}/norms/{start_day},{end_day}?limit=10&offset={offset}"
    ...
    def get_weather_observed(self, latitude, longitude, start_day=None, end_day=None, offset=0):
        """
        ...
        # Define URL variants
        url_no_date = f"{self._geolocation_url}/{latitude},{longitude}/observations?limit=10&offset={offset}"
        url_start_date = f"{self._geolocation_url}/{latitude},{longitude}/observations/{start_day}"
        url_end_date = f"{self._geolocation_url}/{latitude},{longitude}/observations/{end_day}"
        url_both_dates = f"{self._geolocation_url}/{latitude},{longitude}/observations/{start_day},{end_day}?limit=10&offset={offset}"
