...
# -*- coding: utf-8 -*-
#
# awherepy documentation build configuration file, created by
...
man_pages = [(master_doc, "awherepy", u"aWherePy Documentation", [author], 1)]
